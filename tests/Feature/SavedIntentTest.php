...
final class SavedIntentTest extends TestCase
{
    ...
    public function test_saved_intent_page_shows_intent_hub_explanation(): void
    {
        ...
        $this->actingAs($user)
            ...
            ->assertSee('source:web-dl')
            ->assertSee('res:1080p')
            ->assertSee('rg:ntb')
            ->assertSee('sub:danish,english')
            ->assertSee('Search:')
            ->assertSee('Type:')
    ...
    public function test_watch_preset_create_page_prefills_supported_query_values(): void
    {
        ...
        $this->actingAs($user)
            ...
            ->assertSee('placeholder="Try: source:web-dl res:1080p rg:ntb sub:danish,english"', false)
            ->assertSee('Alias examples:', false)
            ->assertSee('source:web-dl', false)
            ->assertSee('res:1080p', false)
            ->assertSee('rg:ntb', false)
            ->assertSee('sub:danish,english', false)
