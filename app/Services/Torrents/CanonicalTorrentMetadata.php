...
final readonly class CanonicalTorrentMetadata
{
    ...
    public static function fromArray(array $attributes): self
    {
        ...
        return new self(
            ...
            language: self::normalizeString($attributes['language'] ?? null),
            audioLanguage: self::normalizeString($attributes['audio_language'] ?? null),
            subtitleLanguage: self::normalizeString($attributes['subtitle_language'] ?? null),
            subtitles: self::normalizeString($attributes['subtitles'] ?? null),
            imdbId: $imdbId,
