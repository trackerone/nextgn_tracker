...
final class DiscoveryOperationsReviewQueueController extends Controller
{
    public function __invoke(Request $request, DiscoveryOperationsReviewQueueService $reviewQueue): JsonResponse
    {
        ...
        return response()->json($reviewQueue->payload($filters), options: JSON_PRESERVE_ZERO_FRACTION);
    }
}
