    ...
    <section class="space-y-6">
        <div class="flex flex-col justify-between gap-4 md:flex-row md:items-end">
            <div>
                ...
                <p class="mt-2 max-w-3xl text-sm text-slate-400">Saved views let you reuse the same metadata intent across browse, RSS, and watch presets. @include('partials.search-alias-guidance')</p>
            </div>
        ...
        @if ($savedIntents->isEmpty())
            <div class="rounded-2xl border border-slate-800 bg-slate-900/70 p-6 text-sm text-slate-300">
                ...
                <p class="mt-2 text-slate-400">Saved views are created from browse filters, then reused here for RSS and watch presets. @include('partials.search-alias-guidance', ['variant' => 'start'])</p>
