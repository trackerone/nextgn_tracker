            ...
            <div class="grid gap-5 md:grid-cols-2">
                ...
                @foreach ([
                    ...
                    <div>
                        ...
                        <input id="{{ $field }}" name="{{ $field }}" value="{{ $value($field) }}" @if ($field === 'q') placeholder="Try: source:web-dl res:1080p rg:ntb sub:danish,english" @endif class="mt-2 w-full rounded-xl border border-slate-700 bg-slate-950 px-4 py-3 text-sm text-slate-100 placeholder:text-slate-500">
                        @if ($field === 'q')
                            <p class="mt-1 text-xs text-slate-500">Alias examples: <code>source:web-dl</code>, <code>res:1080p</code>, <code>rg:ntb</code>, <code>sub:danish,english</code>.</p>
                        @endif
