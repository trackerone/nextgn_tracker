...
const discoveryOperationsReviewQueueElement = document.querySelector<HTMLElement>('[data-discovery-operations-review-queue]');

if (discoveryOperationsReviewQueueElement) {
  ReactDOM.createRoot(discoveryOperationsReviewQueueElement).render(
    <React.StrictMode>
      <DiscoveryOperationsReviewQueuePanel />
    </React.StrictMode>,
  );
}
...
const discoveryOperationsDrilldownElement = document.querySelector<HTMLElement>('[data-discovery-operations-drilldown]');

if (discoveryOperationsDrilldownElement) {
  ReactDOM.createRoot(discoveryOperationsDrilldownElement).render(
    <React.StrictMode>
      <DiscoveryOperationsDrilldownPanel />
    </React.StrictMode>,
  );
}
