...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        ...
        <title><?php echo $__env->yieldContent('title'); ?> | <?php echo e(config('app.name', 'NextGN Tracker')); ?></title>
        <style>
    ...
    <body>
        <div class="error-card">
            <div class="error-code"><?php echo $__env->yieldContent('status', 'Error'); ?></div>
            <div class="error-message"><?php echo $__env->yieldContent('message'); ?></div>
            <a href="<?php echo e(url('/')); ?>"><?php echo e(__('Return to homepage')); ?></a>
        </div>
    </body>
</html>
<?php /**PATH /workspaces/nextgn_tracker/resources/views/errors/layout.blade.php ENDPATH**/ ?>